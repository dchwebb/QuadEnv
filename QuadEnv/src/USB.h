...
private:
	...
	static constexpr std::string_view productString      = "Mountjoy QuadEnv";
	static constexpr std::string_view cdcString          = "Mountjoy QuadEnv CDC";
	static constexpr uint8_t selfPowered = 0;				// Set to 1 if self powered
	static constexpr uint16_t ProductId = 65435;
